...
$IntuneWin32AppParameters = @{
	...
	DetectionRule        = New-IntuneWin32AppDetectionRuleFile -Path "C:\Program Files\Notepad++" -Existence -FileOrFolder "Notepad++.exe" -DetectionType exists
	Icon 	 	         = New-IntuneWin32AppIcon -FilePath "$psscriptroot\package\AppDeployToolkit\AppDeployToolkitLogo.png" 
	Verbose              = $true
    AppVersion           = "Latest"
	Notes                = "Assign this application to install Notepad++ to the user."
