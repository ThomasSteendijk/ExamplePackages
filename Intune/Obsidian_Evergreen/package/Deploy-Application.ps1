...
Try {
    ...
    [String]$appVendor = 'Obsidian'
    [String]$appName = 'Obsidian'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
	  ...
	  $AppActive = get-process -Name "obsidian"  -ErrorAction SilentlyContinue
	  if ($AppActive) {
           Show-InstallationWelcome -CloseApps 'obsidian' -AllowDefer -DeferTimes 3
	  ...
	  winget install obsidian.obsidian --accept-source-agreements | write-log
...
Alternatively, save your work and click 'Close Programs'."
	  ...
	  Start-Process -FilePath "$env:LOCALAPPDATA\Obsidian\Uninstall Obsidian.exe" -ArgumentList "/currentuser /S" -Wait
