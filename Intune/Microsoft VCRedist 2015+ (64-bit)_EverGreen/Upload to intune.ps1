...
$IntuneWin32AppParameters = @{
	...
	DisplayName          = "Microsoft VCredist 2015+ (64-bit)" 
	...
	Verbose              = $true
    AppVersion           = "Latest"
	Notes                = "Assign this application to install The Microsoft Visual C++ 2015-2022 Redistributable Package to the user."
